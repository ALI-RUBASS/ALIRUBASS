...
function Home()
{
    return(
        ...
        <section class="bg-[#1a1d27] relative overflow-hidden">
        <svg class="absolute opacity-20" width="100%" height="100%" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg class="absolute opacity-30" viewBox="0 0 960 637" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* <mask id="mask0_1_167" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="32" width="960" height="573">
        ...
        <div class="relative flex flex-col items-center justify-center max-w-6xl px-8 py-12 mx-auto lg:py-24">
          <div>
            <span class="text-xs font-bold tracking-wide text-white uppercase">Pricing</span>
          ...
          <div class="grid grid-cols-1 gap-8 mt-12 lg:ap-2 lg:grid-cols-3">
            <div class="lg:order-last">
              <div class="flex flex-col">
                <div class="p-8 shadow-2xl rounded-3xl bg-gradient-to-b from-purple-400 via-purple-400 to-purple-600 ring-1 ring-white/10">
                ...
                <div class="px-8">
                  <div>
                    ...
                    <ul class="gap-4 mt-4 space-y-3 text-gray-300 list-none" role="list">
                      <li class="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-500 icon icon-tabler icon-tabler-circle-check" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
